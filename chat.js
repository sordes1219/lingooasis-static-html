(function () {
  ...
  const GUEST_UI_STRINGS = {
    ...
    ru: {
      ...
      safetyItem3: "🔒 Безопасно и приватно",
    ...
    th: {
      ...
      safetyItem3: "🔒 ปลอดภัยและเป็นส่วนตัว",
